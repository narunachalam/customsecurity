...
<HTML>
   ...
   <body MS_POSITIONING="GridLayout">
      ...
      <form id="Form1" method="post" runat="server">
         <asp:Label id="LblUser" style="Z-INDEX: 101; LEFT: 100px; POSITION: absolute; TOP: 152px" runat="server"
         ...
         <!--<asp:TextBox id="TxtGroups" style="Z-INDEX: 103; LEFT: 200px; POSITION: absolute; TOP: 184px " runat="server"
            tabIndex="2" Width="1280px" meta:resourcekey="TxtGrpResource1" TextMode="MultiLine" ></asp:TextBox>
         <asp:Label id="LblGroups" style="Z-INDEX: 102; LEFT: 100px; POSITION: absolute; TOP: 192px" runat="server"
            Width="96px" Font-Size="X-Small" Font-Names="Verdana" Font-Bold="True" meta:resourcekey="TxtGrpResource1">DA roles:</asp:Label>&nbsp;-->
         <asp:TextBox id="TxtPwd" style="Z-INDEX: 103; LEFT: 200px; POSITION: absolute; TOP: 184px" runat="server"
            tabIndex="2" Width="160px" TextMode="Password" meta:resourcekey="TxtPwdResource1"></asp:TextBox>
         <asp:Label id="LblPwd" style="Z-INDEX: 102; LEFT: 100px; POSITION: absolute; TOP: 192px" runat="server"
            Width="96px" Font-Size="X-Small" Font-Names="Verdana" Font-Bold="True" meta:resourcekey="LblPwdResource1">Password:</asp:Label>&nbsp;
         <asp:TextBox id="TxtUser" style="Z-INDEX: 104; LEFT: 200px; POSITION: absolute; TOP: 152px" runat="server"
         ...
         <asp:Label id="Label1" style="Z-INDEX: 108; LEFT: 100px; POSITION: absolute; TOP: 96px" runat="server"
